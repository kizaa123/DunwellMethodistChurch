          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-2.5">
              ...
              <a
                ...
                aria-label="Facebook"
                className="h-9 w-9 rounded-full flex items-center justify-center transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg group"
              ...
              >
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor" style={{ color: "hsl(212,40%,75%)" }}>
              ...
              <a
                ...
                className="h-9 w-9 rounded-full flex items-center justify-center transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg group"
                style={{ background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.12)" }}
                onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.background = "radial-gradient(circle at 30% 107%, #fdf497 0%, #fdf497 5%, #fd5949 45%, #d6249f 60%, #285AEB 90%)"; (e.currentTarget as HTMLElement).style.borderColor = "#d6249f"; }}
                onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.background = "rgba(255,255,255,0.08)"; (e.currentTarget as HTMLElement).style.borderColor = "rgba(255,255,255,0.12)"; }}
              >
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor" style={{ color: "hsl(212,40%,75%)" }}>
              ...
              <a
                ...
                className="h-9 w-9 rounded-full flex items-center justify-center transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg group"
                style={{ background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.12)" }}
                onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.background = "#010101"; (e.currentTarget as HTMLElement).style.borderColor = "#69C9D0"; }}
                onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.background = "rgba(255,255,255,0.08)"; (e.currentTarget as HTMLElement).style.borderColor = "rgba(255,255,255,0.12)"; }}
              >
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor" style={{ color: "hsl(212,40%,75%)" }}>
